...
MySQL - 5.1.28-rc-community : Database - campussay
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`campussay` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
/*Data for the table `t_campus` */

/*Table structure for table `t_campus_experience` */
...
/*Data for the table `t_campus_experience` */
...
/*Data for the table `t_education` */
...
/*Table structure for table `t_special_subject` */
...
/*Data for the table `t_special_subject` */

/*Table structure for table `t_special_subject_taking` */
...
/*Data for the table `t_special_subject_taking` */
...
/*Data for the table `t_star` */

/*Table structure for table `t_student_check` */
...
/*Data for the table `t_student_check` */

/*Table structure for table `t_subject_area` */
...
/*Data for the table `t_subject_area` */

/*Table structure for table `t_taking` */
...
CREATE TABLE `t_taking` (
  ...
  `taking_rootnode` int(11) NOT NULL COMMENT '绑定根节点',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='说友发表的说文产品';

/*Data for the table `t_taking` */

insert  into `t_taking`(`taking_id`,`taking_user`,`taking_title`,`taking_type`,`taking_max_persion`,`taking_now_persion`,`taking_price`,`taking_is_online`,`taking_is_line`,`taking_show_qq`,`taking_show_wechat`,`taking_show_mail`,`taking_show_phone`,`taking_address`,`taking_main_picture`,`taking_target`,`taking_people`,`taking_info`,`taking_campus`,`taking_state`,`taking_rootnode`) values (4,1,'x1',2,50,2,10.00,1,0,1,1,1,1,'x1','img1','1','all','gr测试',1,10,1);

/*Table structure for table `t_taking_class` */
...
/*Data for the table `t_taking_class` */

/*Table structure for table `t_taking_comment` */
...
/*Data for the table `t_taking_comment` */

/*Table structure for table `t_taking_picture` */
...
/*Data for the table `t_taking_picture` */

/*Table structure for table `t_taking_question` */
...
/*Data for the table `t_taking_question` */

/*Table structure for table `t_taking_question_communicat` */
...
/*Data for the table `t_taking_question_communicat` */

/*Table structure for table `t_taking_type` */
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='说文分类表，树形结构';

/*Data for the table `t_taking_type` */

insert  into `t_taking_type`(`taking_type_id`,`taking_type_name`,`taking_type_picture`,`taking_type_floor`,`taking_type_parent`,`taking_type_is_leaf`,`taking_type_state`) values (1,'就业',NULL,'1',0,0,10),(2,'互联网（就）',NULL,'2',1,0,10),(3,'计算机（就）',NULL,'2',1,1,10),(4,'通讯（就）',NULL,'2',1,1,10),(5,'电子（就）',NULL,'2',1,1,10),(6,'微电子（就）',NULL,'2',1,1,10),(7,'创业',NULL,'1',0,0,10),(8,'互联网（创）',NULL,'2',7,1,10),(9,'计算机（创）',NULL,'2',7,1,10),(10,'通讯（创）',NULL,'2',7,1,10),(11,'电子（创）',NULL,'2',7,1,10),(12,'微电子（创）',NULL,'2',7,1,10),(13,'考研',NULL,'1',0,0,10),(14,'公开课',NULL,'2',13,1,10),(15,'专业课',NULL,'2',13,1,10),(16,'Java',NULL,'3',2,1,10);
...
/*Data for the table `t_work_experience` */
