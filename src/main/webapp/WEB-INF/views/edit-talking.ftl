<content tag="title">修改talking-校园说-交流干货,分享人生</content>
<content tag="css">/publish-talk</content>
<content tag="javascript">/edit-talking</content>
			...
			<li class="publish-item">
				<ul class="publish-input-list">
					...
					<li class="publish-input-item">
						...
						<div class="inline-block input-middle mn-select" id="class-calssify">
							<span class="inline-block">请选择</span>
							<ul class="inline-block" id="J_category">
							</ul>
						</div>
						<div class="inline-block input-middle mn-select" id="class-sub-classify">
							<span class="inline-block J_sub">请选择</span>
