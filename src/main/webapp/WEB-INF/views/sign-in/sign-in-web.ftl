<content tag="title">登陆注册-校园说-交流干货,分享人生</content>
<content tag="css">/sign-in/sign-in</content>
<content tag="javascript">/sign-in/sign-in</content>
<div class="global-center">
    <!--logo和切换学校 -->
    <div class="sign-in-warp">
        <img src="/static/img/page/sign-in/sign-in-pic.png"/>
        <!--登陆 -->
        ...
        <form id="register-form-phone" class="sign-register" style="display: none">
            ...
            <a href="/about?navId=UserServiceRule">用户协议</a>
